...
/* ---- Attributes defaults ------------------------------------------------- */
typedef struct { UA_UInt32 specifiedAttributes; UA_LocalizedText displayName; UA_LocalizedText description; UA_UInt32 writeMask; } UA_ObjectAttributes;
typedef struct { UA_UInt32 specifiedAttributes; UA_LocalizedText displayName; UA_LocalizedText description; UA_UInt32 writeMask; UA_NodeId dataType; UA_Int32 valueRank; UA_Variant value; UA_Byte accessLevel; } UA_VariableAttributes;
...
typedef struct { UA_LogFunction log; void *context; int minLevel; int levels; } UA_Logger;
...
UA_StatusCode UA_Server_addMethodNode  (UA_Server *s, UA_NodeId requestedId,
                                        ...
                                        UA_StatusCode (*method)(UA_Server*, const UA_NodeId*,
...
typedef struct { UA_Variant value; int hasValue; uint64_t sourceTimestamp; int sourcePicoseconds; int status; } UA_DataValue;
typedef struct { void *data; size_t length; } UA_Range;  /* opaque range */
